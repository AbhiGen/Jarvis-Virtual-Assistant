...
def ChatBot(Query):
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            top_p=1, # Enable nucleus sampling to control diversity.
...
if __name__=="__main__":
    # Test the ChatBot function with a sample query.
    while True:
        user_input=input("enter your question")
        print(ChatBot(user_input)) # Print the chatbot's response to the user's input.
        print("--------------------------------------------------")